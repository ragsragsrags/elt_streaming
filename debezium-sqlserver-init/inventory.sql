...
WITH
(
SYSTEM_VERSIONING = ON (HISTORY_TABLE = [dbo].[products_archive])
);
...
WITH
(
SYSTEM_VERSIONING = ON (HISTORY_TABLE = [dbo].[products_on_hand_archive])
);
...
WITH
(
SYSTEM_VERSIONING = ON (HISTORY_TABLE = [dbo].[customers_archive])
);
...
WITH
(
SYSTEM_VERSIONING = ON (HISTORY_TABLE = [dbo].[orders_archive])
);
